...
from .views import ReservationCreateView, ReservationPayerView, TicketLookupView, MesReservationsView, MaFideliteView
...
urlpatterns = [
    ...
    path('fidelite/moi/', MaFideliteView.as_view(), name='ma-fidelite'),
